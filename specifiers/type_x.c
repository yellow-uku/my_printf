...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/24 18:48:15 by pkayleen          #+#    #+#             */
/*   Updated: 2021/03/21 16:15:41 by pkayleen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*type_x(t_struct *format)
{
	unsigned int	num;
	int				output_len;
	char			*output;

	format->x = va_arg(format->args, int);
	num = (unsigned int)format->x;
